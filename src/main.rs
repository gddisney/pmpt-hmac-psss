...
impl SpherePoint {
    ...
    fn generate_noise_byte(rng: &mut ChaCha20Rng, stddev: f64) -> Result<u8, NoiseError> {
...
fn main() {
    ...
    let plaintext = "Hello, Cryptography!";
